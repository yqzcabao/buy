...
<?php $action[$op]='on';?>
<ul class="an_tab_nav">
    <li class="fl <?=$action['all'];?>"><a href="<?=u('user','center',array('op'=>'all'));?>"><?=INTEGRAL;?>明细</a></li>
	<li class="fl <?=$action['plus'];?>"><a href="<?=u('user','center',array('op'=>'plus'));?>"><?=INTEGRAL;?>增加</a></li>
	<li class="fl <?=$action['reduce'];?>"><a href="<?=u('user','center',array('op'=>'reduce'));?>"><?=INTEGRAL;?>消耗</a></li>
</ul>
